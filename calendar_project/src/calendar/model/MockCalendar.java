...
public class MockCalendar implements ICalendarsModel {
  ...
  /**
   * Public constructor. Initializes log to empty string.
   */
  public MockCalendar() {
    log = "";
  }
  ...
  public void editCalendar(String name, CalendarProperty property, Object newPropertyValue)
    ...
    if (property.equals(CalendarProperty.TIMEZONE)) {
      log += "editCalendar(" + name + ", " + property.toString() + ", "
            + ((TimeZone) newPropertyValue).toZoneId().toString() + ")\n";
    }
    else {
      log += "editCalendar(" + name + ", " + property.toString() + ", "
  ...
  @Override
  public void copyEventsBetween(LocalDate startDate,
                                LocalDate endDate, String targetCalendarName,
