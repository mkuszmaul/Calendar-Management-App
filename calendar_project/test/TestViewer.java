...
/**
 * Tests the calendar app's viewer, CalendarViewer. Tests CalendarViewer's ability to
 * print bulleted lists of events and show status as busy or not busy.
 */
public class TestViewer {
  ...
  public void testPrint() {
    ...
    assertEquals("- Team Meeting (public) from 2024-03-15T10:00 to 2024-03-15T11:00.\n",
          viewer.printListOfEvents(new ArrayList<IEvent>(Collections.singletonList(event1))));
    assertEquals("- Team Meeting (public) from 2024-03-15T10:00 to 2024-03-15T11:00.\n"
